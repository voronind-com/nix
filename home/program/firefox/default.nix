...
let
  ...
  extensions = [
    ...
    (mkExtension "addon@darkreader.org" "file://${
      pkgs.callPackage <package/darkreader> { }
    }/latest.xpi")
  ...
  prefs = [
    ...
    (mkLockedPref "font.minimum-size.x-cyrillic" (toString config.style.font.size.application))
    (mkLockedPref "font.minimum-size.x-unicode" (toString config.style.font.size.application))
    (mkLockedPref "font.minimum-size.x-western" (toString config.style.font.size.application))
    (mkLockedPref "font.name.monospace.x-cyrillic" config.style.font.monospace.name)
    (mkLockedPref "font.name.monospace.x-unicode" config.style.font.monospace.name)
    (mkLockedPref "font.name.monospace.x-western" config.style.font.monospace.name)
    (mkLockedPref "font.name.sans-serif.x-cyrillic" config.style.font.sansSerif.name)
    (mkLockedPref "font.name.sans-serif.x-unicode" config.style.font.sansSerif.name)
    (mkLockedPref "font.name.sans-serif.x-western" config.style.font.sansSerif.name)
    (mkLockedPref "font.name.serif.x-cyrillic" config.style.font.serif.name)
    (mkLockedPref "font.name.serif.x-unicode" config.style.font.serif.name)
    (mkLockedPref "font.name.serif.x-western" config.style.font.serif.name)
